...
const TermsAndConditionsPage: FC<TermsAndConditionsPageProps> = ({ }) => {
    ...
    return (
        <div>
            ...
            Please read these terms and conditions ("Terms") carefully before using our notetaking app ("the App"). These Terms govern your use of the App, its features, and any associated services provided by us. By using the App, you agree to be bound by these Terms.

            1. Acceptance of Terms
            By accessing and using the App, you acknowledge that you have read, understood, and agree to be bound by these Terms. If you do not agree to these Terms, please refrain from using the App.

            2. License and Intellectual Property
            a. License: We grant you a limited, non-exclusive, non-transferable, revocable license to use the App for personal and non-commercial purposes, subject to these Terms.
            b. Intellectual Property: All intellectual property rights in the App, including but not limited to copyrights, trademarks, logos, and any other proprietary materials, belong to us or our licensors. You agree not to infringe upon or use our intellectual property without our prior written consent.

            3. User Obligations
            a. Registration: You may need to create an account to access certain features of the App. You agree to provide accurate and up-to-date information during the registration process.
            b. Responsible Use: You agree to use the App responsibly and in compliance with applicable laws and regulations. You will not use the App for any illegal, unauthorized, or unethical purposes.
            c. Security: You are responsible for maintaining the confidentiality of your account credentials and ensuring their proper use. Any activities occurring under your account are your sole responsibility.
            d. Prohibited Actions: You shall not engage in any actions that may disrupt or interfere with the functioning of the App, its servers, or networks. This includes but is not limited to hacking, introducing malware, or attempting unauthorized access.

            4. Privacy
            Your privacy is important to us. Our Privacy Policy governs the collection, use, and disclosure of personal information you provide to us. By using the App, you consent to our collection and use of your personal information as outlined in the Privacy Policy.

            5. Disclaimer of Warranty
            The App is provided on an "as is" and "as available" basis, without any warranties or representations, express or implied. We do not guarantee that the App will be error-free, secure, or uninterrupted. You use the App at your own risk.

            6. Limitation of Liability
            To the extent permitted by law, we shall not be liable for any direct, indirect, incidental, consequential, or exemplary damages arising out of or in connection with the use of the App. This includes but is not limited to damages for loss of profits, data, or other intangible losses.

            7. Modifications and Termination
            a. Modifications: We reserve the right to modify or discontinue the App, its features, or these Terms at any time, without prior notice. It is your responsibility to review these Terms periodically for any updates.
            b. Termination: We may terminate your access to the App, temporarily or permanently, if we believe you have violated these Terms or engaged in any prohibited activities.
